...
with open('/dbfs/FileStore/RandomForestResults.txt', 'w') as f:  
  print("Training model with Random Forest algorithm", file=f)
...
with open('/dbfs/FileStore/RandomForestResults.txt', 'a+') as f:  
  print("Classification accuracy of  Random Forest  : ", accuracy, file=f)
...
with open('/dbfs/FileStore/RandomForestResults.txt', 'r') as f:
  print(f.readlines())
